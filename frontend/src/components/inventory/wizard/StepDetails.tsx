...
export default function StepDetails() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-xl font-semibold text-primary-text mb-1">Teknik Detaylar</h2>
        <p className="text-sm text-secondary-text">Referans numarası, üretim yılı ve teknik özellikleri girin.</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Reference Number */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Referans Numarası</label>
          <input
        ...
        {/* Year */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Üretim Yılı</label>
          <input
            {...register('year')}
            type="number"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {/* Case Material */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Kasa Malzemesi</label>
          <select
        ...
        {/* Dial Color */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Kadran Rengi</label>
          <select
        ...
        {/* Movement */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Hareket Tipi</label>
          <select
        ...
        {/* Bracelet Material */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Kayış/Bilezik Malzemesi</label>
          <select
        ...
        {/* Case Diameter */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Kasa Çapı</label>
          <input
            value={watch('features.case_diameter') || ''}
            onChange={(e) => setValue('features.case_diameter', e.target.value)}
            placeholder="Örn: 41mm"
            className="w-full px-4 py-2.5 bg-surface-secondary border border-border-subtle rounded-lg text-primary-text placeholder:text-tertiary-text focus:outline-none focus:ring-2 focus:ring-accent-blue/40 focus:border-accent-blue text-sm"
          />
        </div>
        ...
        {/* Water Resistance */}
        <div>
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Su Direnci</label>
          <input
            value={watch('features.water_resistance') || ''}
            onChange={(e) => setValue('features.water_resistance', e.target.value)}
            placeholder="Örn: 300m"
            className="w-full px-4 py-2.5 bg-surface-secondary border border-border-subtle rounded-lg text-primary-text placeholder:text-tertiary-text focus:outline-none focus:ring-2 focus:ring-accent-blue/40 focus:border-accent-blue text-sm"
          />
        </div>
        ...
        <div className="sm:col-span-2">
          <label className="block text-sm font-medium text-secondary-text mb-1.5">Teslimat Kapsamı</label>
          <select
          ...
          >
            <option value="">Seçiniz</option>
            <option value="Full Set (Box & Papers)">Full Set (Kutu & Belgeler)</option>
            <option value="Box Only">Sadece Kutu</option>
            <option value="Papers Only">Sadece Belgeler</option>
            <option value="Watch Only">Sadece Saat</option>
          </select>
        </div>
      </div>
    </div>

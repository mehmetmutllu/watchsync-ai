  ...
  if (isNaN(watchId)) {
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <p className="text-semantic-error">Geçersiz saat ID.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-primary-text">Saati Düzenle</h1>
          <p className="text-sm text-secondary-text">Saat bilgilerini güncelleyin.</p>
        </div>
      </div>
